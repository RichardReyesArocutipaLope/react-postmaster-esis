const message = "Loading the CIIS 2022 page";
const tamMessage = message.length;

const codAnimation = `export type ReactComponentLike =
| string
...
export {message, tamMessage, codAnimation}